...
HELP_MESSAGE = "You can say tell me a random fact, tell me a (species) fact, how many species are endangered, or, you can say exit... What can I help you with?"
...
class GetNumberOfEndangeredSpeciesHandler(AbstractRequestHandler):
    ...
    def handle(self, handler_input):
        ...
        handler_input.attributes_manager.session_attributes['lastIntent'] = 'GetNumberOfEndangeredSpecies'
        ...
        speech = "There are currently {number} endangered species. {critical_num} of which are critically endangered. What else can I do for you?".format(
            number=num_species,
